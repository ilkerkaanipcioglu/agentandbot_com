defmodule GovernanceCoreWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(GovernanceCoreWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(GovernanceCoreWeb.Gettext, "errors", msg, opts)
    # end
