defmodule GovernanceCoreWeb do
  @moduledoc """
  ...
  def live_view do
    quote do
      use Phoenix.LiveView, layout: {GovernanceCoreWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: GovernanceCoreWeb.Router,
        statics: GovernanceCoreWeb.static_paths()
    end
  end
